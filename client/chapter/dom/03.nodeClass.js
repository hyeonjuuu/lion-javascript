...
// Node – getter 역할을 하는 parentNode, nextSibling, childNodes 등의 주요 트리 탐색 기능을 제공합니다. -> 노드가 부여하는 매서드
...
// 노드에 접근하여 노드의 정보를 변경
// HTML 태그 자체를 삽입하여 위험함..
first.innerHTML = 'helooooooo';
// 기존 내용과 새로운 내용을 합친 새로운 내용을 씀
